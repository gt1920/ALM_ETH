...
REM    Bootloader : 0x08000000 .. 0x080027FF   (10 KB,   5 pages)
REM    Application: 0x08002800 .. 0x0800FFFF   (54 KB,  27 pages)
...
REM Convert app.bin -> app1.hex with App load address 0x08002800
.\srecord\srec_cat.exe .\app.bin -Binary -offset 0x8002800 -o .\app1.hex -Intel
