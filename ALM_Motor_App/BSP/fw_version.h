/* ============================================================================
 *  fw_version.h — single source of truth for the FW version reported by the
 *  ALM_Motor_App in CAN-FD heartbeat frames.
 *
 ...
 *
 *  Used by:
 *    - Core/Src/adjuster_can.c          (Stage_Heartbeat_Init)
 *    - Core/Inc/adjuster_can_report.c   (Stage_Heartbeat_Update)
 * ========================================================================== */
