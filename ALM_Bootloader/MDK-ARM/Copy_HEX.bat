...
REM ============================================================
REM  Copy_HEX.bat
REM  Run by Keil "After Build" step (UserProg2) for ALM_Bootloader.
REM  Copies the freshly-built bootloader hex into ALM_APP's HEX
...
set "DST_DIR=..\..\ALM_APP\HEX\app\Bootloader"
