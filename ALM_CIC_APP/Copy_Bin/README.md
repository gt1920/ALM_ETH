...
- AES Key / IV 写死在 [Program.cs](../../Copy_Bin_CIC_Project/Copy_Bin/Program.cs) 中，必须与 [G0B1_SPI_Bootloader/BSP/AES.c](../../G0B1_SPI_Bootloader/BSP/AES.c) 和 [App/BSP/AES.c](../BSP/AES.c) 三处保持一致。
