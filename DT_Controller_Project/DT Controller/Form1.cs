                ...
                try
                {
                    if (data.Length > 5 && data[0] == 0xA5 && data[1] == 0x01)
                    {
                        ...
                        if (subCmd == 0x01 && data.Length > 13)
                        {
                            ...
                            // 自动发送 Module 清单查询（SubCmd = 0x02），仅发送一次
                            Task.Run(() =>
                            {
                                lock (hidLock)
                                {
